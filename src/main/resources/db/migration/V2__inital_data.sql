...
INSERT INTO project VALUES
    ...
    (null, 'True Detective', 'Police officers and detectives around the USA are forced to face dark secrets about themselves and the people around them while investigating homicides.', '2014-01-12', 'SERIES', 'CRIME', 'chihuahua', TRUE),
    (null, 'Dexter', 'Dexter Morgan, a man with homicidal tendencies, lives a double life. He works as a forensic technician for the police department during the day and kills heinous perpetrators in his free time.', '2006-10-01', 'SERIES', 'DRAMA', 'chihuahua', TRUE),
    (null, 'The Office', 'The show documents the exploits of a paper supply company in Scranton, Pennsylvania. With an office including the likes of various peers, this series takes a look at the lives of its co-workers.', '2004-03-24', 'SERIES', 'COMEDY', 'chihuahua', TRUE),
