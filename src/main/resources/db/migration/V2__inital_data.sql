...
INSERT INTO project VALUES
    ...
    (null, 'Howls Moving Castle', 'Jealous of Sophie''s closeness to Howl, a wizard, the Witch of Waste transforms her into an old lady. Sophie must find a way to break the spell with the help of Howl''s friends, Calcifer and Markl.', '2004-11-20', 'FILM', 'FANTASY', 1),
    (null, 'Arcane', 'The origins of two iconic League champions, set in the utopian Piltover and the oppressed underground of Zaun.', '2021-11-06', 'SERIES', 'ACTION', 1),
    (null, 'Gladiator', 'Commodus takes over power and demotes Maximus, one of the preferred generals of his father, Emperor Marcus Aurelius. As a result, Maximus is relegated to fighting till death as a gladiator.', '2000-05-19', 'FILM', 'ACTION', 1),
